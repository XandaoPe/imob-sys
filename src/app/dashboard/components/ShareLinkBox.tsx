...
const InfoTooltip = ({ text }: { text: string }) => {
    return (
        <span className="group relative inline-flex items-center ml-1">
            <span className="w-4 h-4 rounded-full bg-blue-200 dark:bg-blue-900/60 hover:bg-blue-600 dark:hover:bg-blue-500 hover:text-white text-blue-800 dark:text-blue-300 font-bold text-[10px] flex items-center justify-center transition-colors cursor-help select-none">
                ?
            </span>
